...
function draw(){
	...
	let color_a =  'rgba(255,   0,   0,         0.1)',
	    ...
	    v1[0] = new Vertex(-w/2, -w/2, -w/2, -w/2);
    v1[1] = new Vertex(-w/2-Math.sin(theta)*w, -w/2, -w/2, -w/2+Math.cos(theta)*w);
    v1[2] = new Vertex(-w/2, -w/2, w/2, -w/2);
    v1[3] = new Vertex(-w/2-Math.sin(theta)*w, -w/2, w/2, -w/2+Math.cos(theta)*w);
    v1[4] = new Vertex(-w/2, w/2, -w/2, -w/2);
    v1[5] = new Vertex(-w/2-Math.sin(theta)*w, w/2, -w/2, -w/2+Math.cos(theta)*w);
    v1[6] = new Vertex(-w/2, w/2, w/2, -w/2);
    v1[7] = new Vertex(-w/2-Math.sin(theta)*w, w/2, w/2, -w/2+Math.cos(theta)*w);
    ...
    v2[0] = new Vertex(-w/2, -w/2, -w/2, -w/2);
    v2[1] = new Vertex(-w/2, -w/2-Math.sin(theta)*w, -w/2, -w/2+Math.cos(theta)*w);
    v2[2] = new Vertex(-w/2, -w/2, w/2, -w/2);
    v2[3] = new Vertex(-w/2, -w/2-Math.sin(theta)*w, w/2, -w/2+Math.cos(theta)*w);
    v2[4] = new Vertex(w/2, -w/2, -w/2, -w/2);
    v2[5] = new Vertex(w/2, -w/2-Math.sin(theta)*w, -w/2, -w/2+Math.cos(theta)*w);
    v2[6] = new Vertex(w/2, -w/2, w/2, -w/2);
    v2[7] = new Vertex(w/2, -w/2-Math.sin(theta)*w, w/2, -w/2+Math.cos(theta)*w);
    ...
    v3[0] = new Vertex(-w/2, -w/2, -w/2, -w/2);
    v3[1] = new Vertex(-w/2, -w/2, -w/2-Math.sin(theta)*w, -w/2+Math.cos(theta)*w);
    v3[2] = new Vertex(-w/2, w/2, -w/2, -w/2);
    v3[3] = new Vertex(-w/2, w/2, -w/2-Math.sin(theta)*w, -w/2+Math.cos(theta)*w);
    v3[4] = new Vertex(w/2, -w/2, -w/2, -w/2);
    v3[5] = new Vertex(w/2, -w/2, -w/2-Math.sin(theta)*w, -w/2+Math.cos(theta)*w);
    v3[6] = new Vertex(w/2, w/2, -w/2, -w/2);
    v3[7] = new Vertex(w/2, w/2, -w/2-Math.sin(theta)*w, -w/2+Math.cos(theta)*w);
    ...
    v4[0] = new Vertex(w/2, -w/2, -w/2, -w/2);
    v4[1] = new Vertex(w/2+Math.sin(theta)*w, -w/2, -w/2, -w/2+Math.cos(theta)*w);
    v4[2] = new Vertex(w/2, -w/2, w/2, -w/2);
    v4[3] = new Vertex(w/2+Math.sin(theta)*w, -w/2, w/2, -w/2+Math.cos(theta)*w);
    v4[4] = new Vertex(w/2, w/2, -w/2, -w/2);
    v4[5] = new Vertex(w/2+Math.sin(theta)*w, w/2, -w/2, -w/2+Math.cos(theta)*w);
    v4[6] = new Vertex(w/2, w/2, w/2, -w/2);
    v4[7] = new Vertex(w/2+Math.sin(theta)*w, w/2, w/2, -w/2+Math.cos(theta)*w);
    ...
    v5[0] = new Vertex(-w/2, w/2, -w/2, -w/2);
    v5[1] = new Vertex(-w/2, w/2+Math.sin(theta)*w, -w/2, -w/2+Math.cos(theta)*w);
    v5[2] = new Vertex(-w/2, w/2, w/2, -w/2);
    v5[3] = new Vertex(-w/2, w/2+Math.sin(theta)*w, w/2, -w/2+Math.cos(theta)*w);
    v5[4] = new Vertex(w/2, w/2, -w/2, -w/2);
    v5[5] = new Vertex(w/2, w/2+Math.sin(theta)*w, -w/2, -w/2+Math.cos(theta)*w);
    v5[6] = new Vertex(w/2, w/2, w/2, -w/2);
    v5[7] = new Vertex(w/2, w/2+Math.sin(theta)*w, w/2, -w/2+Math.cos(theta)*w);
    ...
    v6[0] = new Vertex(-w/2, -w/2, w/2, -w/2);
    v6[1] = new Vertex(-w/2, -w/2, w/2+Math.sin(theta)*w, -w/2+Math.cos(theta)*w);
    v6[2] = new Vertex(-w/2, w/2, w/2, -w/2);
    v6[3] = new Vertex(-w/2, w/2, w/2+Math.sin(theta)*w, -w/2+Math.cos(theta)*w);
    v6[4] = new Vertex(w/2, -w/2, w/2, -w/2);
    v6[5] = new Vertex(w/2, -w/2, w/2+Math.sin(theta)*w, -w/2+Math.cos(theta)*w);
    v6[6] = new Vertex(w/2, w/2, w/2, -w/2);
    v6[7] = new Vertex(w/2, w/2, w/2+Math.sin(theta)*w, -w/2+Math.cos(theta)*w);
    ...
    v7[0] = new Vertex(-w/2, -w/2, -w/2, -w/2);
    v7[1] = new Vertex(-w/2, -w/2, w/2, -w/2);
    v7[2] = new Vertex(-w/2, w/2, -w/2, -w/2);
    v7[3] = new Vertex(-w/2, w/2, w/2, -w/2);
    v7[4] = new Vertex(w/2, -w/2, -w/2, -w/2);
    v7[5] = new Vertex(w/2, -w/2, w/2, -w/2);
    v7[6] = new Vertex(w/2, w/2, -w/2, -w/2);
    v7[7] = new Vertex(w/2, w/2, w/2, -w/2);
    ...
    v8[0] = new Vertex(w/2+Math.sin(theta)*w-Math.cos(theta*2)*w, -w/2, -w/2, -w/2+Math.cos(theta)*w+Math.sin(theta*2)*w);
    v8[1] = new Vertex(w/2+Math.sin(theta)*w-Math.cos(theta*2)*w, -w/2, w/2, -w/2+Math.cos(theta)*w+Math.sin(theta*2)*w);
    v8[2] = new Vertex(w/2+Math.sin(theta)*w-Math.cos(theta*2)*w, w/2, -w/2, -w/2+Math.cos(theta)*w+Math.sin(theta*2)*w);
    v8[3] = new Vertex(w/2+Math.sin(theta)*w-Math.cos(theta*2)*w, w/2, w/2, -w/2+Math.cos(theta)*w+Math.sin(theta*2)*w);
    v8[4] = new Vertex(w/2+Math.sin(theta)*w, -w/2, -w/2, -w/2+Math.cos(theta)*w);
    v8[5] = new Vertex(w/2+Math.sin(theta)*w, -w/2, w/2, -w/2+Math.cos(theta)*w);
    v8[6] = new Vertex(w/2+Math.sin(theta)*w, w/2, -w/2, -w/2+Math.cos(theta)*w);
    v8[7] = new Vertex(w/2+Math.sin(theta)*w, w/2, w/2, -w/2+Math.cos(theta)*w);
